...
def calc_S_B(D1,D2,d2,d1): #Площадь сечения воздушной части магнитопровода
    ...
    print(f"Площади сечения воздушной части магнитопровода S_B... {S_B}" )
    return S_B
...
def calc_L_cd(h1,h2,D1,D2,d1,d2): #Длина сечения сердечника
    ...
    print(f"Длины сечения сердечника L_cd... {L_cd}")
...
def calс_S_yakor(l_c3,h3, D1, D2, d1, d2): #Площадь сечения и длина якоря
    ...
    print(f"Площади сечения якоря S_y... {S_y}")
...
def calc_L_S_magnit(L_y,L_cd,S_cd,S_y): #Длина и площадь магнитопровода
    ...
    print(f"Длина магнитопровода L_c.. {L_c}")
    print(f"Площадь магнитопровода S_c... {S_c}")
    return L_c, S_c

def calc_S_ok(D2,d2,h1,K_kp): #Площадь окна катушки
    S_ok = 0.5*(D2-d2)*h1*K_kp
    print(f"Площади окна катушки S_ok... {S_ok}")
    return S_ok

def calc_R_cp(D2,d1): #Средний радиус катушки
    R_cp = (D2-d1)/4
