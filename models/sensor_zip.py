...
class ZIPSensor:
    def __init__(self, D1, D2, d1, d2, h1, h2, h3, l0, z0, d_n, xv, d_zT_min, eta_max, x, K_kp, p_n, mu_0, mu_c):
    ...
    def calc(self):
        ...
        R_cp = geometry_ZIP.calc_R_cp(self.D2, self.d1)
        ...
        R_mb, k_B , R_B0 = electrical_ZIP.calc_R_mb(self.l0, self.mu_0, S_B,x=0)  # x=0 для начального положения
        ...
        eta = electrical_ZIP.calc_eta(R_k, self.z0, d_z)

        f_p = electrical_ZIP.calc_f_p(self.z0,w,eta,R_mC,R_B0)
